...
В интерфейсе заголовок страницы — **«Телефонная нумерация России»**; имя продукта в репозитории, Docker и документации — **PSTN Analytics**.
...
Полный индекс: **[docs/README.md](docs/README.md)** · история релизов: **[CHANGELOG.md](CHANGELOG.md)**
